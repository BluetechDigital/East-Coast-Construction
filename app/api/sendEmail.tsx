...
// Components
import CustomerEnquiryConfirmationEmail from "@/components/Emails/CustomerInquiryConfirmationEmail";
import BusinessCustomerEnquiryConfirmationEmail from "@/components/Emails/BusinessCustomerInquiryConfirmationEmail";
	...
	if (req.method === "POST") {
		...
		try {
			...
			const customerEmail: ICustomerEmail = {
				...
				to: `${data?.email}`,
				subject: `Thank You for Contacting East Coast Construction Ltd`,
