		...
		<>
			...
			<Section style={footer}>
				<Section style={footerLogoSection}>
					<Link href={`https://eastcoastconstructionri.com/`}>
						<Img
							width="250px"
							height="105px"
							style={footerLogo}
							alt="East Coast Construction Ltd Logo White"
							src={`${imagesDirUrl}/East-Coast-Construction-logo-three.jpg`}
						/>
					</Link>
				</Section>
				<Row>
					...
					>
						<Link href={themesOptionsContent?.linkedinLink?.url} style={link}>
							<Img
								...
								height="35px"
								style={{width: "35px", height: "35px"}}
								src={`${imagesDirUrl}/linkedin-round-white.png`}
							/>
						</Link>
					</Column>
				</Row>
