...
> = ({
	...
	return (
		<>
			<Html>
				<Head />
				<Preview>Thank You for Contacting East Coast Construction Ltd</Preview>
				<Body style={main}>
					<Container style={container}>
						<EmailHeader
							imagesDirUrl={`${imagesDirUrl}/East-Coast-Construction-Ltd-Email-Header-Customer-Appointment.png`}
						/>
						<Section style={content}>
							<Text style={introParagraph}>Hi {fullName},</Text>
							<Text style={paragraph}>
								Thank you for reaching out to East Coast Construction Ltd
								regarding, &quot;{subject}&quot; and our services. We have
								received your website appointment request on {formattedDate} and
								are eager to assist you with your details. At this moment there
								is no further action is required from you.
							</Text>
							<Text style={paragraph}>
							...
							<Text style={paragraph}>
								Thank you once again for considering East Coast Construction
								Ltd. We look forward to the opportunity to work with you and
							...
							<Text style={paragraph}>
								...
								<Link
									style={link}
									href={`https://eastcoastconstructionri.com/`}
								>
									eastcoastconstructionri.com
								</Link>
							</Text>
						</Section>
						<EmailFooter
