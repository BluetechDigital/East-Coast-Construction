			...
			<Html>
				...
				<Body style={main}>
					<Container style={container}>
						<EmailHeader
							imagesDirUrl={`${imagesDirUrl}/East-Coast-Construction-Ltd-Email-Header-Customer.png`}
						/>
						<Section style={content}>
							<Text style={introParagraph}>Hi {firstName},</Text>
							<Text style={paragraph}>
								Thank you for reaching out to East Coast Construction Ltd
								regarding, &quot;{subject}&quot; and our {selectedServices}{" "}
								services. We have received your website inquiry on{" "}
							...
							<Text style={paragraph}>
								Thank you once again for considering East Coast Construction Ltd
								for your {selectedServices} needs. We look forward to the
