		...
		<>
			<div className="flex flex-col-reverse lg:flex-row flex-wrap p-4 lg:p-10 -m-4">
				...
				<div className="w-full lg:w-7/12 p-4">
					<div
						className="flex flex-col justify-between bg-white h-full p-8 bg-cover bg-no-repeat bg-center"
						style={{
					...
					>
						<div className="max-w-3xl mx-auto lg:mx-0">
							<motion.h3
								...
								whileInView={fadeIn}
								viewport={{once: true}}
								className="mb-4 text-black uppercase font-aspektaMain leading-relaxed text-center lg:text-left text-lg sm:text-xl lg:text-4xl"
							>
								{title}
							</motion.h3>
							<Paragraph
								content={paragraph}
								tailwindStyling="text-black leading-[1.75rem] text-lg text-center lg:text-left leading-relaxed"
							/>
						</div>
						<Link
							href={`${buttonLink?.url}`}
